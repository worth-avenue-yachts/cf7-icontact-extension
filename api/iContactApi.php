...
class iContactApi {
	...
	**/
	 ...
	 * @return object
	**/
	public function addContact($sEmail, $sStatus = 'normal', $sPrefix = null, $sFirstName = null, $sLastName = null,
														 $sSuffix = null, $sStreet = null, $sStreet2 = null, $sCity = null, $sState = null,
														 $sPostalCode = null, $sPhone = null, $sFax = null, $sBusiness = null, $mascota = null ) {
		// Valid statuses
		...
		// Probando para Custom Fields
		if (!empty($mascota)) {
			// Add the new business
			$aContact['mascota'] = (string) $mascota;
		}
	...
	public function addContactNew($sEmail, $sStatus = 'normal', $sFirstName = null, $customfield = null  ) {
		// Valid statuses
		$aValidStatuses = array('normal', 'bounced', 'donotcontact', 'pending', 'invitable', 'deleted');
		// Contact placeholder
		$aContact       = array(
